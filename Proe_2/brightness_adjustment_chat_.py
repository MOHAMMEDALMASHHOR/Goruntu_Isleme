# -*- coding: utf-8 -*-
"""
Created on Sun Jan  5 17:06:04 2025
...
def preprocess_frame(frame):
    """
    Preprocess the frame to include Gaussian blur, Sobel edge detection, and histogram equalization.
    """
...
while cap.isOpened():
    ...
    equalized, sobel = preprocess_frame(frame)

    # Detect and handle excessively bright areas
    adjusted_frame = detect_bright_areas(frame.copy())
    ...
    cv2.imshow("Equalized Frame", equalized)

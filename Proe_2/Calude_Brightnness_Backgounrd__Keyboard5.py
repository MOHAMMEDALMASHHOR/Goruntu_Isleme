# -*- coding: utf-8 -*-
"""
Created on Mon Jan  6 00:35:07 2025
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  5 22:06:36 2025
...
cooldown_period = 0.5  # 0.5 second cooldown between adjustments

# Brightness thresholds and buffer range
OPTIMAL_BRIGHTNESS_RANGE_FACE = (80, 180)
OPTIMAL_BRIGHTNESS_RANGE_BG = (50, 200)
BUFFER_RANGE = 10
MIN_BRIGHTNESS = 10
MAX_BRIGHTNESS = 100
...
def calculate_optimal_brightness(face_lightness, bg_lightness, current_brightness):
    ...
    # Target ranges (in LAB L channel values)
    ...
    scaling_factor = 0.2  # Controls how aggressive the adjustment is
...
# Update these constants in the main code
...
while cap.isOpened():
    ...
    # Preprocess the frame for additional windows
